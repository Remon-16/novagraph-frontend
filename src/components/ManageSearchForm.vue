<template>
  <div class="picture-search-form">
    ...
    <a-form name="searchForm" layout="inline" :model="searchParams" @finish="doSearch">
      ...
      <a-form-item v-if="props.formType === 'pic' " label="宽度" name="picWidth">
        <a-input-number v-model:value="searchParams.picWidth" />
      </a-form-item>
      <a-form-item v-if="props.formType === 'pic' " label="高度" name="picHeight">
        <a-input-number v-model:value="searchParams.picHeight" />
      </a-form-item>
      <a-form-item v-if="props.formType === 'pic' " label="格式" name="picFormat">
